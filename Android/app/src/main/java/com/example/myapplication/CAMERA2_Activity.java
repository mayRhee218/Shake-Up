...
//        System.out.println("주소값 : " + url);
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Toast.makeText(CAMERA2_Activity.this, "Cannot access the camera.", Toast.LENGTH_SHORT).show();
            finish();
            ...
            mCameraDevice.createCaptureSession(Collections.singletonList(previewSurface),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                            Toast.makeText(CAMERA2_Activity.this, "Failed", Toast.LENGTH_SHORT).show();
                        }
                    }, mBackgroundHandler);
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        File path = new File (recordPath + "/camtest");
        if (!path.exists()) {
            path.mkdirs();
        }
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                            mButtonVideo.setImageResource(R.drawable.stopxml);
//                            mButtonVideo.setText("녹화종료");
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setImageResource(R.drawable.recordxml);
//        mButtonVideo.setText("녹화종료");
//        Toast.makeText(CAMERA2_Activity.this, videoFileName + "에 저장", Toast.LENGTH_SHORT).show();
        // Stop recording
        mMediaRecorder.stop();
