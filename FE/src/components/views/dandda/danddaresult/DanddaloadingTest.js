...
// import { tmposeurl } from "/tmposeurl";
...
const TmPose = () => {
  ...
  const predict = async () => {
    ...
    //       if (
    //         prediction
    //           .find((x) => x.className === dance_sequence_class_name_list[idx].class)
    //           .probability.toFixed(2) > 0.8
    //       ) {
    //         if (Math.abs(gapTime - dance_sequence_class_name_list[idx].time) < 120) {
    //           setGrade({
    //             idx: idx++,
    //             grade: 2,
    //           });
    //         } else if (Math.abs(gapTime - dance_sequence_class_name_list[idx].time) < 200) {
    //           setGrade({
    //             idx: idx++,
    //             grade: 1,
    //           });
